...
export const Filters = () => {
  ...
  const { paginationModel, sortOptions } = useSelector(
    ...
    const handleDateChange = (item) => {
      ...
      const startDate = moment(item.selection.startDate).utcOffset(timezoneOffset, true);
      ...
      dispatch({
        type: 'SET_FILTERS',
        payload: { date: [{ startDate: startDate.toDate(), endDate: endDate?.toDate(), key: 'selection' }] }
      });
    };
